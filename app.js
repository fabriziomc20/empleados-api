...
const allowOrigin = "https://fabriziomc20.github.io";
...
/* =========================
   CANDIDATOS
   ========================= */
const candidatosRoutesFactory = require('./modules/candidatos/candidatos.routes');
...
// Establecer nuevo régimen (versionado) con mejores validaciones y errores claros
